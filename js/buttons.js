...
function confirmacion() {
    ...
    /* Para Imprimir una variable en cadena podemos utilizar las comillas simples inversas ``(ctrl + alt + }) y luego hacemos el llamado de la variable con ${aqui debera de escribir el nombre de la variable} */
